...
- 0.6 - Adds basic dark-mode support. Adds new stream: Hackney Brook, based on Finsbury Park (partial port). Adds new CSS variables to all streams to support Finsbury Parks two main differences to Shoreditch and Greenwich: button icons styling (unique colours, background, border), and contact dashboard side tabs with active/hover border, similar to the 5.72 SearchKit UI.
