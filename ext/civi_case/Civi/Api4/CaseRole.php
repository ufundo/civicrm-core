...
/**
 * CaseRoleCache - API wrapper on RelationshipCache to facilitate joining and finding contacts with a role on a case
 *
...
#    return (new Action\CaseRoleCache\Get(__CLASS__, __FUNCTION__))
...
#    return (new Action\CaseRoleCache\GetFields(__CLASS__, __FUNCTION__))
#      ->setCheckPermissions($checkPermissions);
#  }
